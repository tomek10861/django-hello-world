  ...
  //      echo 'Git clone from:' nodeEnv
        log = sh(returnStdout:true, script: ('git branch: dev, changelog: false, credentialsId: \'1a83e8db-8990-44e5-8402-d991ecc3b7f1\', poll: true, url: \'https://github.com/tomek10861/django-hello-world.git\'')).trim()
